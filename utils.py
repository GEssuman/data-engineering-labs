...
def get_all_data(spark, base_url, movie_ids, headers):
    """
    ...
    movies_df = convert_to_dataframe(spark, movies)
    credits_df = convert_to_dataframe(spark, credits)
...
def convert_to_dataframe(spark, json_data):
    """
